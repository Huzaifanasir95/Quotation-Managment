-- Insert sample business entities data
INSERT INTO business_entities (name, legal_name, gst_number, tax_id, address, city, state, country, postal_code, phone, email, is_active) VALUES
...
SELECT COUNT(*) as total_records FROM business_entities;
SELECT name, legal_name, country FROM business_entities ORDER BY name;
