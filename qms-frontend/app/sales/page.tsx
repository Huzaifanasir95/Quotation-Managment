          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{salesData?.pendingQuotations || 0}</p>
              </div> 
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">${salesData?.salesThisMonth?.toLocaleString() || '0'}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{salesData?.topCustomers?.length || 0}</p>
              </div>
            ...
            <p className="mt-2 text-sm text-purple-600">${salesData?.topCustomers?.reduce((sum, c) => sum + c.totalQuotes, 0).toLocaleString() || '0'} total value</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{salesData?.recentInquiries || 0}</p>
              </div>
