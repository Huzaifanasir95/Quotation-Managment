        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium text-center">Create Invoice from Order</span>
              <span className="text-xs opacity-90 mt-1">Generate Invoice</span>
            </button>

            <button
              onClick={handleAutoGenerate}
              disabled={isLoading}
              className="flex flex-col items-center justify-center p-5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50"
            >
              <svg className="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <span className="text-sm font-medium text-center">Auto-Generate Invoices</span>
              <span className="text-xs opacity-90 mt-1">Bulk Processing</span>
            </button>
          </div>
        </div>
              ...
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900">{selectedInvoice.customers?.email || 'N/A'}</p>
                  </div>
                  <div>
