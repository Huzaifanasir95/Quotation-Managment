      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 overflow-hidden">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="group relative bg-white border-2 border-gray-200 rounded-lg p-5 hover:border-blue-500 hover:shadow-lg transition-all duration-200"
          >
            <div className="absolute top-3 right-3 w-7 h-7 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-sm group-hover:bg-blue-500 group-hover:text-white transition-colors">
              1
            </div>
            <div className="mb-3">
              <svg className="w-12 h-12 text-gray-400 group-hover:text-blue-500 transition-colors mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h4 className="text-base font-bold text-gray-900 mb-2">Classic Format</h4>
            <p className="text-xs text-gray-600 mb-3">Traditional professional layout with structured table design</p>
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-purple-200 rounded-lg p-5 hover:border-purple-500 hover:shadow-lg transition-all duration-200"
          >
            <div className="absolute top-3 right-3 w-7 h-7 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center font-bold text-sm group-hover:bg-purple-500 group-hover:text-white transition-colors">
              2
            </div>
            <div className="mb-3">
              <svg className="w-12 h-12 text-purple-400 group-hover:text-purple-600 transition-colors mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
              </svg>
            </div>
            <h4 className="text-base font-bold text-gray-900 mb-2">Modern Format</h4>
            <p className="text-xs text-gray-600 mb-3">Contemporary Anoosh International branded design</p>
            <div className="flex flex-wrap gap-1 justify-center">
              <span className="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded">Branded</span>
              <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs rounded">Stylish</span>
            </div>
          </button>

          {/* Option 3: Premium Format */}
          <button
            onClick={() => generatePDFWithFormat('premium')}
            className="group relative bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 border-2 border-amber-300 rounded-lg p-5 hover:border-amber-500 hover:shadow-xl transition-all duration-200"
          >
            <div className="absolute top-3 right-3 w-7 h-7 bg-gradient-to-r from-amber-400 to-orange-500 text-white rounded-full flex items-center justify-center font-bold text-sm group-hover:scale-110 transition-transform">
              3
            </div>
            <div className="mb-3">
              <svg className="w-12 h-12 text-amber-500 group-hover:text-orange-600 transition-colors mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
              </svg>
            </div>
            <h4 className="text-base font-bold text-gray-900 mb-2">Premium Format</h4>
            <p className="text-xs text-gray-600 mb-3">Ultra-modern executive design with advanced features</p>
            <div className="flex flex-wrap gap-1 justify-center">
              <span className="px-2 py-1 bg-amber-100 text-amber-800 text-xs rounded font-semibold">⭐ Premium</span>
