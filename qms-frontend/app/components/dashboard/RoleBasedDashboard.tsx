        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
          ...
          <RoleGuard roles={['admin', 'sales']}>
            ...
            >
              ...
              <span className="text-xs opacity-90 mt-1">New Client</span>
            </button>
          </RoleGuard>
          ...
          <RoleGuard roles={['admin', 'procurement']}>
            ...
            >
              ...
              <span className="text-xs opacity-90 mt-1">New Supplier</span>
            </button>
          </RoleGuard>
          ...
          <RoleGuard roles={['admin', 'finance']}>
            <button
              ...
              className="flex flex-col items-center justify-center p-5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all duration-200 shadow-sm hover:shadow-md"
            >
              <svg className="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <span className="text-sm font-medium text-center">Create Invoice</span>
              <span className="text-xs opacity-90 mt-1">Generate Bill</span>
            </button>
          </RoleGuard>
          ...
          <RoleGuard roles={['admin', 'procurement']}>
            ...
            >
              ...
              <span className="text-xs opacity-90 mt-1">Stock Control</span>
            </button>
          </RoleGuard>
