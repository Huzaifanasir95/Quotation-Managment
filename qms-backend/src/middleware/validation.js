...
const schemas = {
  ...
  quotation: Joi.object({
    ...
    reference_number: Joi.string().allow('', null).optional().default(''),
    reference_no: Joi.string().allow('', null).optional().default(''), // Allow both field names
    terms_conditions: Joi.string().allow('', null).optional().default(''),
    notes: Joi.string().allow('', null).optional().default(''),
    items: Joi.array().items(
      Joi.object({
        product_id: Joi.string().uuid().allow(null).optional(),
        description: Joi.string().required(),
        category: Joi.string().allow('', null).optional().default(''),
        serial_number: Joi.string().allow('', null).optional().default(''),
